...
/**
 * $ondPlayTweaks — patches de performance e correcao do modpack Saphira III.
 *
 ...
 * o nome de exibicao e que carrega o "$ondPlayTweaks".
 */
...
public class SondPlayTweaks {
    ...
    public static final String NAME    = "$ondPlayTweaks";
